document.addEventListener('DOMContentLoaded', () => {
    ...
    async function getToken() {
        const response = await fetch('https://forestry-app-6wzfdltqa-bertuskha.vercel.app/api/getToken');
    ...
    async function getNumImages() {
        const response = await fetch('https://forestry-app-6wzfdltqa-bertuskha.vercel.app/api/getNumImages');
